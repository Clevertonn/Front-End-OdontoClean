      ...
      <View style={styles.container}>
        ...
        <View style={styles.header}>
          <Image 
            ...
            style={styles.image} 
          />
          <Text style={styles.name}>OdontoClean</Text>
        </View>
...
const styles = StyleSheet.create({
  container: {
    flex: 1,
    padding: 20,
    backgroundColor: 'white', // Cor marrom claro (igual ao estilo de GerenciamentoUser)
  },
  title: {
    fontSize: 24,
    fontWeight: 'bold',
    color: 'black', // Cor do texto mais escura para o título
    marginBottom: 20,
    textAlign: 'center',
  },
  header: {
  ...
  menuButton: {
    backgroundColor: '#3871c1', // Cor marrom escuro (igual ao estilo de GerenciamentoUser)
    marginBottom: 10,
  },
  searchButton: {
    backgroundColor: '#3871c1', // Cor marrom escuro para o botão de pesquisa
    marginVertical: 10,
  },
  agendamentoItem: {
    padding: 10,
