...
const GerenciamentoAgendamentoUser = () => {
  ...
  return (
    ...
    <LinearGradient colors={['white', 'white']} style={styles.gradientBackground}>
      <PaperProvider>
...
const styles = StyleSheet.create({
  ...
  zebraRowEven: {
    backgroundColor: '#3871c1', // Marrom bem clarinho
  },
  zebraRowOdd: {
    backgroundColor: 'white', // Outra variação de tom claro
  },
  dataTable: {
    minWidth: 600,
    borderRadius: 5,
  ...
  agendamentoButton: {
    backgroundColor: '#3871c1', // Cor marrom (ou o tom que preferir)
  },
  deleteButton: {
  ...
  titleContainer: {
    ...
    borderColor: '#3871c1', // Cor da borda
