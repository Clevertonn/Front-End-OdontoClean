...
const GerenciamentoAgendamento = () => {
  ...
  return (
    ...
    <LinearGradient colors={['white', 'white', 'white']} style={styles.gradientBackground}>
      <PaperProvider>
...
const styles = StyleSheet.create({
  ...
  tableHeader: {
    backgroundColor: '#3871c1', // Marrom mais escuro para o cabeçalho
    borderTopLeftRadius: 5,
    borderTopRightRadius: 5,
  },
  zebraRowEven: {
    backgroundColor: 'white', // Marrom bem clarinho
  },
  zebraRowOdd: {
    backgroundColor: '#3871c1', // Outra variação de tom claro
  },
  dataTable: {
    minWidth: 600,
    borderRadius: 5,
  ...
  currentDataContainer: {
    marginBottom: 15,
    padding: 10,
    backgroundColor: '#3871c1', // Cor de fundo leve
    borderRadius: 5,
  },
  ...
  agendamentoFormContainer: {
    ...
    backgroundColor: '#3871c1', // Cor de fundo marrom claro
  },
  agendamentoInput: {
  ...
  agendamentoButton: {
    backgroundColor: '#8ddfff', // Cor marrom (ou o tom que preferir)
  },
  deleteButton: {
  ...
  titleContainer: {
    backgroundColor: '#3871c1', // Cor de fundo do título
