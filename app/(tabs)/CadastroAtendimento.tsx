            ...
            <View style={styles.modalContent}>
              <TouchableOpacity
                ...
                style={[
                  ...
                  newAgendamento.dataAtendimento ? { borderColor: '#3871c1', borderWidth: 2 } : {}
                ]}
                activeOpacity={0.7}
              >
              ...
              <View style={[
                ...
                newAgendamento.horario ? { borderColor: '#3871c1', borderWidth: 2 } : {}
              ]}>
                <Picker
              ...
              <View style={[
                styles.pickerContainer,
                selectedServico ? { borderColor: '#3871c1', borderWidth: 2 } : {}
              ]}>
                <Picker
...
const styles = StyleSheet.create({
  ...
  picker: {
    height: '100%',
    width: '100%',
    color: 'black', // cor do texto dentro do picker
  },
